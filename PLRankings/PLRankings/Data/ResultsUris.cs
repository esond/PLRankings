...
namespace PLRankings.Data
{
    ...
    {
        public static IEnumerable<string> OpenMen2016
        {
            get
            {
                yield return //2016
        ...
        public static IEnumerable<string> OpenWomen2016
        {
            get
            {
                yield return //2016
                    "http://www.powerlifting.ca/cgi-bin/webdata_cpudb.pl?3+Lift%2FSingle=&M+%2F+F=F&Prov.=AB&Age+Category=&BW%2FCl.+=&BW-CL-NEW=&Year=2016&NAME=&Uneq%3F=y&Contest=&cgifunction=Search&pagenum=1&cgisort=17&cgisortorder=1";
            }
        }

        public static IEnumerable<string> JuniorMen2016
        {
            get
            {
        ...
        public static IEnumerable<string> JuniorWomen2016
        {
            get
            {
                yield return //2016 Junior
        ...
        public static IEnumerable<string> MastersMen2016
        {
            get
            {
        ...
        public static IEnumerable<string> MastersWomen2016
        {
            get
            {
                yield return //2016 M1
